...
public class Scheduler {
    ...
    public void schedule(final String name, final Runnable func, long delay, long period, TimeUnit unit) {
        scheduleHelper(name,func,delay,period,unit,false);
    }

    /*Added by Hao*/
    public void scheduleHelper(final String name, final Runnable func,
                                  long delay, long period, TimeUnit unit, boolean executeNow) {
        ensureStarted();
